...
- **Network controls** - per-sandbox egress allow/deny rules, plus a log of every HTTP and HTTPS connection a sandbox made to a public address on ports 80 and 443
